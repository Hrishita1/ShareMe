                    ...
                    <div className='flex items-center justify-between'>
                        <div className='flex gap-2'>
                            <a href={`${image?.asset?.url}?dl=`}
                                ...
                                className='bg-white w-9 h-9 flex p-2 rounded-full items-center justify-center text-dark opacity-75 text-xl hover:opacity-100 hover:shadow-md outline-none'
                            >
